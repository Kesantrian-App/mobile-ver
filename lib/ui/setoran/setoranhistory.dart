...
class SetoranHistory extends StatefulWidget {
  @override
  _SetoranHistoryState createState() => _SetoranHistoryState();
}

class _SetoranHistoryState extends State<SetoranHistory> {
